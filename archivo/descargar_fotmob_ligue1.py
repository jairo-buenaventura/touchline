...
para todos los partidos de Ligue 1 2025/26 que aun no tengan
...
Uso:
    python3 descargar_fotmob_ligue1.py
"""
...
LEAGUE_ID_FOTMOB = 53  # Ligue 1 en FotMob
CARPETA_FOTMOB = Path("partidos_fotmob")
DEMORA_ENTRE_PARTIDOS = 2.5  # segundos, para no saturar el sitio

# Los 380 partidos oficiales de la Ligue 1 2025/26
# (ronda, fecha, local, visitante, marcador)
FIXTURES_RAW = Path(__file__).parent / "ligue1_fixtures.csv"
...
def nombre_archivo_esperado(home, away, marcador):
    return f"{home} {marcador} {away} - Ligue 1 2025-2026_FotMob.json"
...
def cargar_calendario_fotmob(request_context):
    ...
    FotMob) y fecha.
    """
    url = "https://www.fotmob.com/api/data/leagues?id=53&season=2025/2026&ccode3=FRA"
