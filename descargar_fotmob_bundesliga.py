"""
descargar_fotmob_bundesliga.py
--------------------------------
...
para todos los partidos de Bundesliga 2025/26 que aun no tengan
...
Uso:
    python3 descargar_fotmob_bundesliga.py
"""
...
LEAGUE_ID_FOTMOB = 54  # Bundesliga en FotMob
CARPETA_FOTMOB = Path("partidos_fotmob")
DEMORA_ENTRE_PARTIDOS = 2.5  # segundos, para no saturar el sitio

# Los 380 partidos oficiales de la Bundesliga 2025/26
# (ronda, fecha, local, visitante, marcador)
FIXTURES_RAW = Path(__file__).parent / "bundesliga_fixtures.csv"
...
def nombre_archivo_esperado(home, away, marcador):
    return f"{home} {marcador} {away} - Bundesliga 2025-2026_FotMob.json"
...
def cargar_calendario_fotmob(request_context):
    ...
    FotMob) y fecha.
    """
    url = "https://www.fotmob.com/api/data/leagues?id=54&season=2025/2026&ccode3=GER"
